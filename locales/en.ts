export const en = {
	...
	"recovery-no-backup-description": "You can restore this account by importing your recovery phrase and setting a new local password.",
	"recovery-phrase-not-linked": "That recovery phrase does not match any wallet linked to this account.",
	"local-wallet-mismatch-title": "A different local wallet was detected",
	"local-wallet-mismatch-description": "The wallet stored on this device does not match your current account. Restore the correct wallet to continue.",
	...
	"onboarding-recover-invalid-local-description": "The local wallet on this device does not match your account. Restore your wallet with a PIN or by importing your recovery phrase.",
