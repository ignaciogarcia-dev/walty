export const es = {
	...
	"recovery-phrase-placeholder": "Escribe aquí tus 24 palabras separadas por espacios",
	"recovery-import-wallet": "Importar wallet",
	"recovery-no-backup": "No encontramos un backup en el servidor",
	"recovery-no-backup-description": "Puedes restaurar esta cuenta importando tu frase de recuperación y creando una nueva contraseña local.",
	"recovery-phrase-not-linked": "La frase de recuperación no corresponde a una wallet vinculada a esta cuenta.",
	"local-wallet-mismatch-title": "Detectamos una wallet local distinta",
	"local-wallet-mismatch-description": "La wallet guardada en este dispositivo no coincide con tu cuenta actual. Para continuar, restaura la wallet correcta.",
	...
	"onboarding-recover-invalid-local-description": "La wallet local de este dispositivo no coincide con tu cuenta. Restaura tu wallet con PIN o importando tu frase de recuperación.",
