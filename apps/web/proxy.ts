...
function buildCsp(nonce: string, isDev: boolean, apiConnectSrc: string): string {
  return isDev
    ? [
        ...
        `connect-src 'self' https://*.alchemy.com https://rpc.ankr.com https://ethereum.publicnode.com https://polygon-bor.publicnode.com https://arb1.arbitrum.io https://mainnet.base.org https://mainnet.optimism.io https://api.github.com ws://localhost:* http://localhost:* ws://127.0.0.1:* http://127.0.0.1:*${apiConnectSrc}`,
        `object-src 'none'`,
        `base-uri 'self'`,
    ...
    : [
        ...
        `style-src 'self' 'unsafe-inline'`,
        `img-src 'self' data: https://assets.coingecko.com https://coin-images.coingecko.com https://static.coingecko.com`,
        `connect-src 'self' https://*.alchemy.com https://rpc.ankr.com https://ethereum.publicnode.com https://polygon-bor.publicnode.com https://arb1.arbitrum.io https://mainnet.base.org https://mainnet.optimism.io https://api.github.com${apiConnectSrc}`,
        `object-src 'none'`,
        `base-uri 'self'`,
        `frame-ancestors 'none'`,
